...
public class C02KakaoLoginController {
    ...
    private final String CLIENT_ID = "e81273c537f5d9484fb2750d7992d0cd";
    ...
    //인가코드 요청 URL
    //https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=e81273c537f5d9484fb2750d7992d0cd&redirect_uri=http://localhost:8080/th/kakao/callback
    @GetMapping("/getCode")
    public void authorize(HttpServletResponse response) throws IOException {
        String url = "https://kauth.kakao.com/oauth/authorize?response_type=code&client_id="+CLIENT_ID+"&redirect_uri="+REDIRECT_URL;
...
//        System.out.println(response.getBody());
    ...
    // 나에게 메시지 보내기 기능 구현
    // 01 scope=talk_message 권한 부여 받기
    @GetMapping("/getCodeMsg")
    public void authorize_Msg(HttpServletResponse response) throws Exception {
        String url = "https://kauth.kakao.com/oauth/authorize?response_type=code&client_id="+CLIENT_ID+"&redirect_uri="+REDIRECT_URL+"&scope=talk_message";
        response.sendRedirect(url);
    }
